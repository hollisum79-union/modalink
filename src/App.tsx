...
function computeNetPay(input: any) {
  ...
  const nightTotalHours = (isKyobun ? kyobunNightHours : nightHoursPerShift * nightCount) + dutyNightHours;
...
const [unreadReportCount, setUnreadReportCount] = useState(0);
  ...
  const newMenus = [
    ...
    },
    {
      ...
      label: "연차·기타휴가",
      sub: "내 권리 계산",
      icon: "M17.553 16.75a7.5 7.5 0 0 0 -10.606 0M18 3.804a6 6 0 0 0 -8.196 2.196l10.392 6a6 6 0 0 0 -2.196 -8.196zM16.732 10c1.658 -2.87 2.225 -5.644 1.268 -6.196c-.957 -.552 -3.075 1.326 -4.732 4.196M15 9l-3 5.196M3 19.25a2.4 2.4 0 0 1 1 -.25a2.4 2.4 0 0 1 2 1a2.4 2.4 0 0 0 2 1a2.4 2.4 0 0 0 2 -1a2.4 2.4 0 0 1 2 -1a2.4 2.4 0 0 1 2 1a2.4 2.4 0 0 0 2 1a2.4 2.4 0 0 0 2 -1a2.4 2.4 0 0 1 1 -.25",
    },
    {
      id: "distance",
      label: "주행키로",
      sub: "무사고 누적",
      icon: "M3 17a2 2 0 1 0 4 0a2 2 0 0 0 -4 0M17 17a2 2 0 1 0 4 0a2 2 0 0 0 -4 0M5 17h5.5a3.5 3.5 0 0 0 0 -7h-3a3.5 3.5 0 0 1 0 -7h4.5",
    },
    {
      id: "notice",
      label: "공지사항",
